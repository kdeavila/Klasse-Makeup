...
export default function Footer() {
  return (
    <footer className="bg-foreground text-background dark:bg-primary-foreground dark:text-foreground">
      <div className="w-full max-w-7xl mx-auto p-8 2xl:px-0">
        <div className="flex flex-col md:flex-row justify-between items-center mb-6">
          ...
          <nav className="w-full md:w-auto">
            <ul className="flex flex-col md:flex-row justify-center md:justify-end">
              {[
                { href: "/", label: "Inicio" },
                ...
                <li key={link.href} className="w-full md:w-auto">
                  <Link
                    href={link.href}
                    className="block text-center p-3 border-b-[1px] md:border-b-0 border-muted-foreground/30 hover:bg-primary dark:hover:bg-accent md:px-6 transition"
                  >
                    {link.label}
                  </Link>
                </li>
        ...
        <div className="text-center text-background/30 dark:text-foreground/40 tracking-wide md:text-left text-sm">
