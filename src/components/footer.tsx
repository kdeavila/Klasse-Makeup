  ...
  return (
    <footer className="bg-foreground dark:bg-primary-foreground text-primary-foreground dark:text-foreground mx-auto 2xl:px-0">
      {isWideScreen ? (
          ...
          <div className="flex items-center justify-between gap-8">
            ...
            <div className="items-center flex text-sm">
              ...
              <Separator
                ...
                className="h-5 bg-background/10 dark:bg-foreground/10"
              />
              <Link className="px-6" href="/favorites">
                Favoritos
              </Link>
              <Separator
                orientation="vertical"
                className="h-5 bg-background/10 dark:bg-foreground/10"
              />
              <Link className="px-6" href="/products">
                Productos
              </Link>
              <Separator
                orientation="vertical"
                className="h-5 bg-background/10 dark:bg-foreground/10"
              />
              <Link className="px-6" href="/politics">
                Políticas
              </Link>
            </div>
          </div>
        ...
        <div className="w-full p-8 2xl:px-0">
          <div className="flex flex-col gap-8">
            ...
            <div className="flex flex-col text-sm">
              ...
              <Separator
                ...
                className="bg-background/10 dark:bg-foreground/10"
              />
              ...
              <Separator
                ...
                className="bg-background/10 dark:bg-foreground/10"
              />
              <Link className="py-3" href="/politics">
                Políticas
              </Link>
            </div>
          </div>
