...
export default function FavoriteProducts() {
    ...
    return (
        <Section title="Productos favoritos" description="Productos que has guardado en tu lista de deseos."
            className="max-w-2xl mt-section-bottom">
                                    ...
                                    <div key={product.id}
                                        ...
                                        <div className="flex items-center">
                                            <Image src={product.images[0]}
                                                ...
                                                width={100} height={100} alt={`Imagen del producto ${product.name}`} />

                                            <div className="space-y-0.5">
                                                <h3 className="font-bold uppercase text-base">{product.name}</h3>
